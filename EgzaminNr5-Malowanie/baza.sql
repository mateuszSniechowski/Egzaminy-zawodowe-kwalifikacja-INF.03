...
INSERT INTO `malowanie`(`id_pomieszczenia`, `id_sciany`, `id_farby`, `liczba_puszek`) VALUES(3, 3, 1, 4);
...
SELECT kolor, cena / pojemnosc as cena1 FROM farby 


Kwerenda 3: wybierającą jedynie nazwy kolorów farb dla pomieszczenia 3
SELECT kolor FROM farby WHERE id_farby IN (SELECT id_farby FROM malowanie WHERE id_pomieszczenia = 3) 